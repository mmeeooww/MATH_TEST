...
public class jamanak extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jamanak);
        ...
        btn1 = (Button) findViewById(R.id.button49);
        btn2 = (Button) findViewById(R.id.button48);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.button48) {
            if (edi1.getText().toString().equals("")||edi2.getText().toString().equals("")||
                ...
                if (n1 * 60 == m1 && n2 * 60 == m2 && n3 * 24 == m3 && n4 * 1440 == m4 && n5 * 7 == m5 && n8 * 168 == m8 && n6 * 12 == m6 && n7 * 100 == m7) {
                    ...
                    if (n1 * 60 == m1) {
                        ...
                        datark += "строка 1, правильный ответ:  " + n1 * 60 + "  " + '\n';
                    }
                    if (n2 * 60 == m2) {
                        gnah++;
                    } else {
                        datark += "строка 2, правильный ответ: " + n2 * 60 + "  " + '\n';
                    }
               if (n3 * 24 == m3) {
                    gnah++;
                } else {
                    datark += "строка 3, правильный ответ: "+ n3*24 + "  "+ '\n';;
                }
                if (n4 * 1440 == m4) {
                    gnah++;
                } else {
                    datark += "строка 4, правильный ответ:  "+ n4*1440+ "  "+ '\n';
                }
                if (n5 * 7 == m5) {
                    gnah++;
                } else {
                    datark += "строка 5, правильный ответ:  "+ n5*7+ "  "+ '\n';
                }
                if (n6 * 168 == m6) {
                    gnah++;
                } else {
                    datark += "строка 6, правильный ответ:  "+ n6*168+ "  " + '\n';
                }
                if (n7 * 12 == m7) {
                    gnah++;
                } else {
                    datark += "строка 7, правильный ответ:  "+ n7*12+ "  "+ '\n';
                }
                if (n8 * 100 == m8) {
                    gnah++;
                } else {
                    datark += "строка 8, правильный ответ:  "+ n8*100+ "  "+ '\n';
                }
                }
                results.setText(datark);
